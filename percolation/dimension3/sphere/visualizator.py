...
class Visualizator: 
    ...
    def get_spheres_traces(self, positions=None):
        ...
        spheres = positions if any(positions) else self.generator.shuffled_extended_spheres
        ...
        for s in spheres:
            ...
            traces.append(go.Surface(x=x, y=y, z=z, showscale=False, lighting=dict(diffuse=0)))
    ...
    def display_distribution(self, distribution_results, display_all=False):
        ...
        for p, f in zip(fits.items(), distributions.items()):
            ...
            traces.append(go.Scatter(x=x, y=y,mode='lines+markers',name=name))
    ...
    def display_all_results(self, distribution_results, positions=None):
        ...
        traces_points = self.display_distribution(distribution_results, display_all=True)
